...
**Filename convention.** `[project_name]_prism[version]_master_[phase-derived versioning].md`. E.g., `acme_audit_prism2.0_master_p2.3.md`.
...
**Ratification triggers P0 → P1.** Master filename bumps to P1 (e.g., `acme_audit_prism2.0_master_p1.0.md`). Setup probes close. Strategy moves to "presumed stable, revisable at convergence" per §6.5.
...
- **Phase transitions** (P0→P1, P1→P2, etc.) — major filename version advances:
  `acme_audit_prism2.0_master_p0.4.md` → `acme_audit_prism2.0_master_p1.0.md`
