<!-- PRISM v2.12.3 Skill bundle (on-demand reference). Cowork capability surface + repo_backed mechanics (sections 3.5.2-3.5.3). Fetch when a non-default orchestration surface or persistence value is in play.
