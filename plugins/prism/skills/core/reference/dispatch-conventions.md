<!-- PRISM v2.18.0 Skill bundle (on-demand reference). Dispatch conventions reference — the promoted §A–H convention set, the promotion map, the canonical execution-paste model, and the digest-preimage pin (Appendix J). Fetch when building or converging a dispatch.
