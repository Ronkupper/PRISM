<!-- PRISM v2.16.0 Skill bundle (on-demand reference). Lanes, roles, the PRISM UI, and Setup onboarding (Appendix I). Fetch when lanes / Desk / UI / onboarding work is in front of you.
