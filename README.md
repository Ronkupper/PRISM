...
1. Attach `PRISM.md` (or `PRISM_v2_1_0.md` for the version-pinned copy) to a fresh Claude chat.
...
- `PRISM_v{n}.md` — versioned snapshot of PRISM.md at the corresponding tag (e.g., `PRISM_v2_1_0.md`); for git-tag recovery per [`RELEASING.md`](./RELEASING.md). Not the primary install target.
