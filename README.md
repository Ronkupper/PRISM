...
> *Prefer a 13-slide overview? See [`PRISM_teaser.pdf`](./assets/PRISM_teaser.pdf).*
...
- **Mobile-friendly.** Mobile-first by design, phone-tested down to the markdown. Desktop works too.
