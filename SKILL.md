...
- `PRISM.md` (always-current) or `PRISM_v2_3_1.md` (version-pinned)
- `PRISM_lens_library.md` v0.11 (canonical catalog; `prism-lens-v0.11` tag)
...
(`name: prism-v2`) — separate loader, body lives in `PRISM_v2_3_1.md`.
