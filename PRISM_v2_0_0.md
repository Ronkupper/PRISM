...
The Lens Library v0.9 (`lens/PRISM_lens_library.md`, tag `prism-lens-v0.9`)
is the canonical catalog. This section specifies how it integrates with v2
mechanics. The catalog itself is not duplicated here.
